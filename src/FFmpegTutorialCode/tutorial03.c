          ...
          */
          data_size =av_samples_get_buffer_size
                ...
                if (!swr_ctx)
                {
                    ...
                    av_opt_set_int(swr_ctx, "out_channel_layout", aCodecCtx->channel_layout, 0);
                ...
                int ret = swr_convert(swr_ctx, &decode_buffer, frame.nb_samples, (const uint8_t **) &frame.data[0],
                                        frame.nb_samples);
                if (ret < 0)
                {
                ...
                memcpy(audio_buf, decode_buffer, data_size);
